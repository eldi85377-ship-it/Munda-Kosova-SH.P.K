  ...
  if (window.I18N) {
    I18N.register({
      en: {
        ...
        'hero.title': 'LIGHTING THE FUTURE<br><span class="grad">OF MOBILITY</span>',
        'hero.sub': 'Illuminated textile systems for the vehicles of tomorrow — designed in Kosovo, engineered for the world.',
        'hero.play': 'START', 'hero.explore': 'EXPLORE MUNDA',
        ...
        'gallery.t4': 'LED core', 'gallery.t5': 'Gameplay', 'gallery.t6': 'Technology',
        ...
        'gallery.c6': 'The MUNDA textile light technology — flexible LEDs woven directly into fabric.',
        ...
        'about.r1t': 'Joint venture', 'about.r1d': 'MUNDA Textile Lichtsysteme GmbH — founded 2019 by AUNDE & MENTOR, Erkrath, Germany.',
        'about.r2t': 'Audi A3 Facelift', 'about.r2d': '2024 — the first series-production car with MUNDA textile light in the door trims.',
        'about.r3t': 'Obiliq plant', 'about.r3d': 'MUNDA Kosova SH.P.K. since March 2023 · plant inaugurated April 2025.',
        'about.r4t': 'First in Kosovo', 'about.r4d': 'The first Volkswagen Group-approved supplier in Kosovo.',
        'contact.kicker': 'CONTACT',
        'contact.title': 'Get in <em>touch.</em>',
        'contact.sub': 'Questions, partnerships or careers — the MUNDA Kosova team in Obiliq and the MUNDA headquarters in Erkrath are ready to help.',
        'contact.addrT': 'Kosovo plant', 'contact.addrV': 'Rruga Koliqi, Nr. 5 · 42000 Obiliq, Kosovo',
        'contact.hqT': 'Headquarters', 'contact.hqV': 'MUNDA Textile Lichtsysteme GmbH · Heinrich-Hertz-Straße 7 · Erkrath, Germany',
        'contact.emailT': 'Email', 'contact.emailV': 'welcome@munda.tech',
        'contact.phoneT': 'Phone', 'contact.phoneV': '+49 211 695289 92',
        'contact.webT': 'Website', 'contact.webV': 'www.munda.tech',
        'contact.linkedin': 'LinkedIn · @munda-kosova',
        'contact.regT': 'Business registration',
        'contact.regV': 'MUNDA Kosova SH.P.K. · NUI 812019132 · founded 1 March 2023 · capital €500,000',
        'contact.formT': 'Send a message',
        'contact.fName': 'Your name', 'contact.fEmail': 'Your email', 'contact.fSubj': 'Subject',
        'contact.fMsg': 'Your message', 'contact.fSend': 'SEND MESSAGE',
        'contact.mapT': 'Find us in Obiliq',
        'mondo.btn': 'AI PËR TY',
        'mondo.status': 'MUNDA AI · knowledge base',
        'mondo.ph': 'Ask Mondo about MUNDA…',
        'auto.kicker': 'AUTOMOTIVE', 'auto.title': 'Real light, <em>real cars.</em>',
        'auto.sub': 'From the first series-production Audi with MUNDA textile light to the cabins of tomorrow — our systems live inside premium vehicles.',
        'auto.c1': 'Audi A3 Facelift — the world\'s first series car with textile light in the door trims.',
        'auto.c2': 'Ambient textile lighting — large illuminated surfaces, crash-safe.',
        'auto.c3': 'Premium cabin interiors with MUNDA lighting technology.',
        'innov.kicker': 'INNOVATION', 'innov.title': 'From yarn to <em>light.</em>',
        'innov.sub': 'How MUNDA brings a new technology from the laboratory to the road.',
        'innov.y1t': '2019 · The joint venture', 'innov.y1d': 'AUNDE & MENTOR found MUNDA Textile Lichtsysteme GmbH in Erkrath — technical textiles meet LED technology.',
        'innov.y2t': '2023 · Kosovo steps in', 'innov.y2d': 'MUNDA Kosova SH.P.K. is registered in Obiliq with €500,000 capital — production starts close to home.',
        'innov.y3t': '2024 · World premiere', 'innov.y3d': 'The Audi A3 Facelift is the first series vehicle with MUNDA textile lighting in its door trims.',
        'innov.y4t': '2025 · Inauguration', 'innov.y4d': 'The Obiliq plant opens officially — Kosovo\'s first Volkswagen Group-approved supplier delivers components.',
      ...
      sq: {
        ...
        'nav.team': 'Stafi', 'nav.contact': 'Kontakt',
        'nav.play': 'LUAJ', 'nav.playGame': 'LUAJ LOJËN',
        'hero.kicker': 'MUNDA KOSOVA SH.P.K · NDRIÇIM TEKSTIL AUTOMOTIV',
        'hero.title': 'NDRIÇIMI I TË ARDHMES<br><span class="grad">SË LËVIZJES</span>',
        'hero.sub': 'Sisteme tekstili të ndriçuar për automjetet e së ardhmes — të dizajnuara në Kosovë, të inxhinieruara për botën.',
        'hero.play': 'START', 'hero.explore': 'EKSPLORO MUNDA-N',
        ...
        'gallery.t4': 'Bërthama LED', 'gallery.t5': 'Momenti i lojës', 'gallery.t6': 'Teknologjia',
        ...
        'gallery.c6': 'Teknologjia e dritës tekstile MUNDA — LED fleksibël të endur direkt në pëlhurë.',
        ...
        'about.r1t': 'Sipërmarrje e përbashkët', 'about.r1d': 'MUNDA Textile Lichtsysteme GmbH — themeluar 2019 nga AUNDE & MENTOR, Erkrath, Gjermani.',
        'about.r2t': 'Audi A3 Facelift', 'about.r2d': '2024 — makina e parë serike me dritë tekstili MUNDA në panelet e dyerve.',
        'about.r3t': 'Fabrika në Obiliq', 'about.r3d': 'MUNDA Kosova SH.P.K. që nga marsi 2023 · fabrika e inauguruar në prill 2025.',
        'about.r4t': 'I pari në Kosovë', 'about.r4d': 'Furnizuesi i parë i miratuar nga Grupi Volkswagen në Kosovë.',
        'contact.kicker': 'KONTAKT',
        'contact.title': 'Na <em>kontakto.</em>',
        'contact.sub': 'Pyetje, partneritete apo karrierë — ekipi i MUNDA Kosova-s në Obiliq dhe selia e MUNDA-s në Erkrath janë gati të ndihmojnë.',
        'contact.addrT': 'Fabrika në Kosovë', 'contact.addrV': 'Rruga Koliqi, Nr. 5 · 42000 Obiliq, Kosovë',
        'contact.hqT': 'Selia qendrore', 'contact.hqV': 'MUNDA Textile Lichtsysteme GmbH · Heinrich-Hertz-Straße 7 · Erkrath, Gjermani',
        'contact.emailT': 'Email', 'contact.emailV': 'welcome@munda.tech',
        'contact.phoneT': 'Telefoni', 'contact.phoneV': '+49 211 695289 92',
        'contact.webT': 'Faqja', 'contact.webV': 'www.munda.tech',
        'contact.linkedin': 'LinkedIn · @munda-kosova',
        'contact.regT': 'Regjistrimi i biznesit',
        'contact.regV': 'MUNDA Kosova SH.P.K. · NUI 812019132 · themeluar 1 mars 2023 · kapital €500,000',
        'contact.formT': 'Dërgo një mesazh',
        'contact.fName': 'Emri yt', 'contact.fEmail': 'Email-i yt', 'contact.fSubj': 'Subjekti',
        'contact.fMsg': 'Mesazhi yt', 'contact.fSend': 'DËRGO MESAZHIN',
        'contact.mapT': 'Na gjej në Obiliq',
        'mondo.btn': 'AI PËR TY',
        'mondo.status': 'MUNDA AI · baza e njohurive',
        'mondo.ph': 'Pyet Mondo-n për MUNDA-n…',
        'auto.kicker': 'AUTOMOTIVE', 'auto.title': 'Dritë reale, <em>makina reale.</em>',
        'auto.sub': 'Nga Audi-u i parë serik me dritë tekstili MUNDA te kabinat e së ardhmes — sistemet tona jetojnë brenda automjeteve premium.',
        'auto.c1': 'Audi A3 Facelift — makina e parë serike në botë me dritë tekstili në panelet e dyerve.',
        'auto.c2': 'Ndriçim ambient tekstil — sipërfaqe të mëdha të ndriçuara, të sigurta në përplasje.',
        'auto.c3': 'Kabina premium me teknologjinë e ndriçimit MUNDA.',
        'innov.kicker': 'INOVACIONI', 'innov.title': 'Nga fija te <em>drita.</em>',
        'innov.sub': 'Si e sjell MUNDA një teknologji të re nga laboratori në rrugë.',
        'innov.y1t': '2019 · Sipërmarrja', 'innov.y1d': 'AUNDE & MENTOR themelojnë MUNDA Textile Lichtsysteme GmbH në Erkrath — tekstilet teknike takojnë teknologjinë LED.',
        'innov.y2t': '2023 · Hyn Kosova', 'innov.y2d': 'MUNDA Kosova SH.P.K. regjistrohet në Obiliq me kapital €500,000 — prodhimi fillon pranë shtëpisë.',
        'innov.y3t': '2024 · Premiera botërore', 'innov.y3d': 'Audi A3 Facelift është automjeti i parë serik me ndriçim tekstil MUNDA në panelet e dyerve.',
        'innov.y4t': '2025 · Inaugurimi', 'innov.y4d': 'Fabrika në Obiliq hapet zyrtarisht — furnizuesi i parë i miratuar nga Grupi Volkswagen në Kosovë dërgon komponentë.',
