  ...
  if (window.I18N) {
    I18N.register({
      en: {
        ...
        'about.title': 'MUNDA Kosova.<br>Light from the <em>heart of the Balkans.</em>',
        'about.p1': 'MUNDA produces illuminated textile systems for the automotive industry — flexible LED technology woven directly into fabric, manufactured at the company\u2019s factory in Obiliq, Kosovo.',
      ...
      sq: {
        ...
        'about.kicker': 'RRETH PROJEKTIT',
        'about.title': 'MUNDA Kosova.<br>Dritë nga <em>zemra e Ballkanit.</em>',
        'about.p1': 'MUNDA prodhon sisteme tekstili të ndriçuar për industrinë automobilistike — teknologji LED fleksibël e endur direkt në pëlhurë, e prodhuar në fabrikën e kompanisë në Obiliq, Kosovë.',
